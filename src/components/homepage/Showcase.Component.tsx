    ...
    <>
      <section className='pt-14'>
        <div className='container max-w-[1550px] relative'>
          <div className='grid grid-cols-12 gap-8'>
            <div className='col-span-7'>
              <div className='text-right'>
                <h1 className='text-hero text-theme-blue-gulf font-bold leading-[170px] relative inline-block'>
                  React
                  <div className='absolute -top-8 -left-12'>
                    <Image src={TitleTopSvg} width={85} alt='title top svg' />
                  </div>
                </h1>
                <h1 className='text-hero text-theme-blue-gulf font-bold leading-[170px]'>Conference</h1>
              </div>
          ...
          <a href='#conference-details' className='absolute bottom-5 left-2/4 animate-bounce'>
